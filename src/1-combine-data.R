...
message("2/7 Now creating time_count_matrix with dcast().\n")
...
message("3/7 Now creating dist_count_matrix with dcast().\n")
...
message("4/7 Now reading and combining covariates.\n")
for (i in 1:n_proj)
{
  p <- project_list$V1[i]
